...
import { ClaudeDesktopTab } from "./components/ClaudeDesktopTab.jsx";
import { AntigravityTab } from "./components/AntigravityTab.jsx";

const TABS = [
  { key: "web", label: "🌐 Browser Chats", render: () => <BrowserChatsTab /> },
  { key: "cli", label: "💻 Claude Desktop App", render: () => <ClaudeDesktopTab /> },
      ...
      <div className="max-width-wrapper">
        <div style={{ marginBottom: 40, textAlign: "left" }}>
          ...
          <p className="subtitle">
            Export any web-based AI chat, local Claude Desktop App session, or Google Antigravity transcript as a beautifully formatted Markdown file. 100% private and runs entirely locally.
          </p>
        </div>
